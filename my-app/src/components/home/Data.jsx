...
const Data = () => {
  return (
    <div className="home_data">
        <h1 className='home_title'>Sadman Mahin
...
<svg
                ...
                <h3 className='home_subtitle'>UX/UI Designer</h3>
                <p className="home_description">I'm creative designer and I'm passionate and dedicated to my work.</p>
